        ...
        <section className="section">
          ...
          <EntitySummary
            rows={[
              ...
              ["Age", selectedSnapshotAgent?.ageYears !== undefined ? `${formatNumber(selectedSnapshotAgent.ageDays ?? agent.ageTicks)} days / ${formatNumber(selectedSnapshotAgent.ageYears)} years` : `${"ageTicks" in agent ? agent.ageTicks.toString() : "0"} days`],
              ...
              ["Personality", selectedSnapshotAgent?.personality ? `${selectedSnapshotAgent.personality.label} / ${selectedSnapshotAgent.personality.dominantTrait}` : "Balanced"],
